...
async def main():
    ...
    # uncomment the below code  from 94 to the 98 in case of stdio 
    #result = await graph.ainvoke({
    #    "messages": [HumanMessage(content="what's (3 + 5) x 12? Use the Math tool.")]
    #})

    #print("result is ::;",result["messages"][-1].content)   
